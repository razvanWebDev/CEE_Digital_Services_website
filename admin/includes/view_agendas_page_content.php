...
<a class="btn btn-primary" href="agendas_page_content.php?source=add_agendas_page_content">Add one column time slot</a>
<a class="btn btn-primary" href="agendas_page_content.php?source=add_agendas_page_content_two_columns">Add two columns time slot</a>
...
<table class="table table-responsive table-bordered table-hover text-center">
    ...
    <tbody>
        ...
        while($row = mysqli_fetch_assoc($select_all_posts_query)) {
            ...
            echo "<td><a href='agendas_page_content.php?source=edit_agendas_page_content&id={$id}'>Edit</a></td>";
            echo "<td><a href='agendas_page_content.php?delete={$id}' onClick=\"javascript:return confirm('Delete time slot?');\">Delete</a></td>";
            echo "</tr>";
        }         
        ?>
    </tbody>            
