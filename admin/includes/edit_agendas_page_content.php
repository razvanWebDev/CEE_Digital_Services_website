<?php 
    ...
    if(isset($_POST['delete_foto_1'])){
        deleteFile("delete_foto_1", "agendas_page_content", "foto_1", "id", $edit_id);
    }
    if(isset($_POST['delete_foto_2'])){
        deleteFile("delete_foto_2", "agendas_page_content", "foto_2", "id", $edit_id);
    }
    if(isset($_POST['delete_foto_3'])){
        deleteFile("delete_foto_3", "agendas_page_content", "foto_3", "id", $edit_id);
    }
    if(isset($_POST['delete_foto_4'])){
        deleteFile("delete_foto_4", "agendas_page_content", "foto_4", "id", $edit_id);
    }
    if(isset($_POST['delete_right_column_foto_1'])){
        deleteFile("delete_right_column_foto_1", "agendas_page_content", "right_column_foto_1", "id", $edit_id);
    }
    if(isset($_POST['delete_right_column_foto_2'])){
        deleteFile("delete_right_column_foto_2", "agendas_page_content", "right_column_foto_2", "id", $edit_id);
    }
    if(isset($_POST['delete_right_column_foto_3'])){
        deleteFile("delete_right_column_foto_3", "agendas_page_content", "right_column_foto_3", "id", $edit_id);
    }
    if(isset($_POST['delete_right_column_foto_4'])){
        deleteFile("delete_right_column_foto_4", "agendas_page_content", "right_column_foto_4", "id", $edit_id);
    }
    
    $query = "SELECT * FROM agendas_page_content WHERE id = $edit_id";
    ...
    if(isset($_POST['edit'])) {
        ...
        if(ifExists(escape($_FILES['foto_1']['name']))){
            deleteFileFromRow("agendas_page_content", "foto_1", $edit_id, "../img/Event_speakers/");
            uploadImage('foto_1', '../img/Event_speakers/', 'foto_1');
        }

        if(ifExists(escape($_FILES['foto_2']['name']))){
            deleteFileFromRow("agendas_page_content", "foto_2", $edit_id, "../img/Event_speakers/");
            uploadImage('foto_2', '../img/Event_speakers/', 'foto_2');
        }

        if(ifExists(escape($_FILES['foto_3']['name']))){
            deleteFileFromRow("agendas_page_content", "foto_3", $edit_id, "../img/Event_speakers/");
            uploadImage('foto_3', '../img/Event_speakers/', 'foto_3');
        }

        if(ifExists(escape($_FILES['foto_4']['name']))){
            deleteFileFromRow("agendas_page_content", "foto_4", $edit_id, "../img/Event_speakers/");
