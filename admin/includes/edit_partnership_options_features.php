<?php 
    ...
    $query = "SELECT * FROM partnership_options_features WHERE id = $edit_id";
    ...
    if(isset($_POST['edit'])) {          
        ...
        $query = "UPDATE partnership_options_features SET ";
        ...
        header("Location: partnership_options_features.php");
        exit();
    }
?>
