<?php 
        ...
        $query = "SELECT * FROM association_partner_dropdown WHERE id = $edit_id";
        ...
        if(isset($_POST['edit'])) {
            ...
            $query = "UPDATE association_partner_dropdown SET ";
            ...
            header("Location: association_partner_dropdown.php");
            exit();
        }    
?>
