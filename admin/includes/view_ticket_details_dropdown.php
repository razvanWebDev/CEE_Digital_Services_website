...
<a class="btn btn-primary" href="ticket_details_dropdown.php?source=add_ticket_details_dropdown">Add new value</a>
...
<table class="table table-responsive table-bordered table-hover text-center">
    ...
    <tbody>
        ...
        while($row = mysqli_fetch_assoc($select_all_posts_query)) {
            ...
            echo "<td><a href='ticket_details_dropdown.php?source=edit_ticket_details_dropdown&id={$id}'>Edit</a></td>";
            echo "<td><a href='ticket_details_dropdown.php?delete={$id}' onClick=\"javascript:return confirm('Delete?');\">Delete</a></td>";
            echo "</tr>";
        }         
        ?>
    </tbody>            
