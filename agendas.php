...
<?php include "PHP/nav.php"; ?>
    ...
    <section>
        <h2 class="centered">8:00am - “Doors” open. <br> (Time zone: CET Central European Time)</h2>
        <p class="centered padding-bottom-2-em"><a href="https://www.youtube.com/watch?v=I1HUIWRyU6M"
                target="_blank">(See how the Hopin platform works - YouTube)</a></p>
        ...
        <div class="separator blue"></div>
        <h2 class="centered padding-bottom-1-em">17:15– 18:00 Closing, & Announcement of the Top 3 CEE Solutions Awards;
            1-on-1 Video Meetings. </h2>
